...
**Provide a typed, config-driven entity-lifecycle state machine primitive for CuraOS services, built on XState v5.**
...
- Typecheck passes.
- Unit tests cover valid and invalid transition attempts.
- Build passes.
...
| Area | Detail |
|---|---|
| Package | `@curaos/workflow-state-sdk` |
